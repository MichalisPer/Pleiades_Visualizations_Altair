...
In the following map, we can see the distribution of pleiades' locations around the world. It is obvious that the **majority** of locations are around **Mediterranean Sea**, but with this visualization we cannot distinguish any of the locations.
...
![World First Photo](Material/SecondVisualization/WorldFirstPhoto.png)
![World Second Photo](Material/SecondVisualization/WorldSecondPhoto.png)
...
![Final First Photo](Material/SecondVisualization/FinalFirstPhoto.png)
![Final Second Photo](Material/SecondVisualization/FinalSecondPhoto.png)
![Final Third Photo](Material/SecondVisualization/FinalThirdPhoto.png)
![Final Fourth Photo](Material/SecondVisualization/FinalFourthPhoto.png)
